...
export class KeywordsComponent {
  topKeywords = [
    { rank: 1, keyword: 'adult daycare', count: 1247, percent: 24.8 },
    { rank: 2, keyword: 'senior care', count: 986, percent: 19.6 },
    { rank: 3, keyword: 'elderly care services', count: 743, percent: 14.8 },
    { rank: 4, keyword: 'daycare for seniors', count: 612, percent: 12.2 },
